...
* 文档：[ros wiki](https://wiki.ros.org/cn)、[ROS2 wiki](https://docs.ros.org/en/humble/Tutorials/Beginner-CLI-Tools/Configuring-ROS2-Environment.html)（英文）、[ROS2 wiki](http://dev.ros2.fishros.com/doc/Tutorials/Configuring-ROS2-Environment.html)（鱼香ROS中文译版）
